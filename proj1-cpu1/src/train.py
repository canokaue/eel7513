...
if __name__ == '__main__':
    ...
    train_dataloader = torch.utils.data.DataLoader(cropped_train, batch_size=const.BATCH_SIZE, shuffle=True, num_workers=4)
    ...
    val_dataloader = torch.utils.data.DataLoader(cropped_val, batch_size=const.VAL_BATCH_SIZE, shuffle=False, num_workers=4)
